...
The goal of this system is to provide independent and precise control of a 24-LED matrix composed of high-power LEDs [cite: 592]. The architecture is divided into two main stages: two dedicated PCA9685 PWM controllers that handle 12 channels each, and individual power modules equipped with AL8861 components 
...
The ESP32 executes the embedded program and transmits brightness instructions via I2C (SDA/SCL) [cite: 778, 786, 787]. Pull-up resistors (R1, R2) ensure stable data transmission. 
...
A 3D-printed box housing a legacy interface with a screen and rotary encoder to manually control brightness [cite: 1023].

## Documentation & Links
* **General Git**: [science-jubilee](https://github.com/leosabatie-eng/science-jubilee) [cite: 1036]
* **Well Illumination Controller**: [24PowerLEDsController](https://github.com/rayanyahiaoui_13/24PowerLEDsController) [cite: 1039]
